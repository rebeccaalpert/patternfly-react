...
class Tabs extends React.Component {
  render() {
    ...
    return ariaLabel
      ? <TabsWithNav id={id} ariaLabel={ariaLabel} {...props} />
      : <TabsWithDiv id={id} {...props} />;
  }
}

const TabsWithNav = ({ activeKey, ariaLabel, className, isFilled, id, isSecondary, showLeftScrollButton, showRightScrollButton, highlightLeftScrollButton, highlightRightScrollButton, ...props }) => (
  <nav {...props}
...
const TabsWithDiv = ({ activeKey, className, isFilled, id, isSecondary, showLeftScrollButton, showRightScrollButton, highlightLeftScrollButton, highlightRightScrollButton, ...props }) => (
  <div {...props}
    className={css(
      styles.tabs,
      isFilled && styles.modifiers.fill,
        ...
        {children.map((child, index) => (
          ...
          >
            <Tab {...child.props}
              ...
              id={child.props.tabContentId ? `pf-tab-${child.props.eventKey}-${child.props.tabContentId}` : `pf-tab-${child.props.eventKey}-${child.props.id || id}`}
...
const InternalTabContainer = ({activeKey, children, id, ...props}) => (
  <React.Fragment>
    {children.map((child, index) => (
      !child.props.children ? null : <TabContent key={index} activeKey={activeKey} child={child} index={index} id={child.props.id || id} />
    ))}
  </React.Fragment>
);
